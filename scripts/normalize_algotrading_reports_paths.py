...
def main() -> int:
    ...
    reports_root = repo_root / "vault" / "Projects" / "AlgoTrading" / "Reports"
    ...
    changed_count = 0
    for path in _iter_md_files(reports_root):
    ...
    manifest_path = reports_root / "normalize_reports_paths_manifest.json"
